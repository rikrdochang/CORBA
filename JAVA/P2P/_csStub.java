...
public class _csStub extends org.omg.CORBA.portable.ObjectImpl implements P2P.cs
{
  ...
  public P2P.amigo[] logueo (String correo, String pass, P2P.sc tmp, P2P.cc aux)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
                ...
                return logueo (correo, pass, tmp, aux        );
            } finally {
                _releaseReply ($in);
            }
  } // logueo
  ...
  public String[] buscaAmigos (String nombre)
  {
            org.omg.CORBA.portable.InputStream $in = null;
            try {
