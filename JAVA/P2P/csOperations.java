...
{
  short pedirAmistad (String correo1, String correo2);
  P2P.amigo[] logueo (String correo, String pass);
  short registro (String correo, String pass, String nombre);
  boolean desregistro (String correo);
  short modPass (String correo, String pass1, String pass2);
