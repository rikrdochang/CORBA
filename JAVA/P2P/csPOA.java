 ...
 implements P2P.csOperations, org.omg.CORBA.portable.InvokeHandler
{
  ...
  static
  {
    ...
    _methods.put ("modPass", new java.lang.Integer (3));
    _methods.put ("deslogueo", new java.lang.Integer (4));
    _methods.put ("aceptarAmistad", new java.lang.Integer (5));
  }
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    switch (__method.intValue ())
    {
       ...
       case 1:  // P2P/cs/logueo
       {
         ...
         $result = this.logueo (correo, pass, tmp);
         out = $rh.createReply();
       ...
       case 5:  // P2P/cs/aceptarAmistad
       {
         String correo = in.read_string ();
         boolean $result = false;
         $result = this.aceptarAmistad (correo);
         out = $rh.createReply();
         out.write_boolean ($result);
         break;
       }
